...
impl FromStr for KeyType {
	type Err = crate::near::errors::ParseKeyTypeError;
...
impl TryFrom<u8> for KeyType {
	type Error = crate::near::errors::ParseKeyTypeError;
...
fn split_key_type_data(
	value: &str,
) -> Result<(KeyType, &str), crate::near::errors::ParseKeyTypeError> {
...
impl TryFrom<&[u8]> for Secp256K1PublicKey {
	type Error = crate::near::errors::ParseKeyError;
...
impl<'de> serde::Deserialize<'de> for PublicKey {
		...
		D: serde::Deserializer<'de>,
	{
		...
		s.parse().map_err(|err: crate::near::errors::ParseKeyError| {
...
impl FromStr for PublicKey {
	type Err = crate::near::errors::ParseKeyError;
...
impl Secp256K1Signature {
	...
	pub fn recover(
		&self,
		msg: [u8; 32],
	) -> Result<Secp256K1PublicKey, crate::near::errors::ParseSignatureError> {
...
impl TryFrom<&[u8]> for Secp256K1Signature {
	type Error = crate::near::errors::ParseSignatureError;
		...
		match signature_type {
			...
			KeyType::SECP256K1 =>
				Ok(Signature::SECP256K1(Secp256K1Signature::try_from(signature_data).map_err(
					|_| crate::near::errors::ParseSignatureError::InvalidData {
...
impl FromStr for Signature {
	type Err = crate::near::errors::ParseSignatureError;
...
impl<'de> serde::Deserialize<'de> for Signature {
	...
	{
		let s = <String as serde::Deserialize>::deserialize(deserializer)?;
		s.parse().map_err(|err: crate::near::errors::ParseSignatureError| {
			serde::de::Error::custom(err.to_string())
		})
	}
}
...
impl core::convert::From<DecodeBs58Error> for crate::near::errors::ParseKeyError {
	fn from(err: DecodeBs58Error) -> Self {
		match err {
			DecodeBs58Error::BadLength { expected, received } =>
				crate::near::errors::ParseKeyError::InvalidLength {
...
impl core::convert::From<DecodeBs58Error> for crate::near::errors::ParseSignatureError {
	fn from(err: DecodeBs58Error) -> Self {
		match err {
			DecodeBs58Error::BadLength { expected, received } =>
